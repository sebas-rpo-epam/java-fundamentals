...
public class AnalyticsListener implements DomainEventListener {

    @Override
    public void onEvent(DomainEvent event) {
        if (event instanceof OrderPlacedEvent e) {
            System.out.println("  [ANALYTICS] Recording order metric: " + e.total() + " for " + e.orderId());
        }
    }
    ...
    @Override
    public String listenerName() { return "AnalyticsListener"; }
}
